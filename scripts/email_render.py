...
def embed_gauge_data_uri(gauge_path):
    """Website: relative path, goes live atomically with the post when the PR
    merges. Email: base64-embedded, so it works immediately, before/without
    any merge at all."""
