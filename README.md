...
- `scripts/generate_daily.py` — Haiku picks the day's top story, writes it
- `scripts/generate_weekly.py` — Sonnet picks 5–7 stories, writes the roundup + Buttondown draft
